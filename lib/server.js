...
Server.prototype.attach = function() {
  ...
  this.pollTransport.on('close', this.emit.bind(this, 'close'));
  this.pollTransport.on('error', this.emit.bind(this, 'error'));
  ...
  // this.webSocketTransport.on('close', this.emit.bind(this, 'close'));
  // this.webSocketTransport.on('error', this.emit.bind(this, 'error'));
