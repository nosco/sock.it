...
PollConnection.prototype.createBody = function(messages, cb) {
  ...
  if (typeof this.request !== 'undefined' &&
    typeof this.request.headers !== 'undefined' &&
    typeof this.request.headers['accept-encoding'] !== 'undefined') {

    acceptStr = this.request.headers['accept-encoding'];
  }

  var method = '';
  if (acceptStr.match(/\bgzip\b/i)) {
    method = 'gzip';
  } else if (acceptStr.match(/\bdeflate\b/i)) {
    method = 'deflate';
  }
