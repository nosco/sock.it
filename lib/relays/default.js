...
// DefaultRelay.prototype.handlePollRequest = function(request, response, clientInfo) {
//   if(this.connectionsByConnId[clientInfo.connId]) {
//     delete this.connectionsByConnId[clientInfo.connId];
//   }

//   response.on('close', function() {
//     console.log('Relay:handlePollRequest:close called');
//     // @todo how can we detect, when to delete / shut down this conn?
//     // if this.connectionsByConnId[conn.clientInfo.connId]
//     // delete this.connectionsByConnId[conn.clientInfo.connId]
//     // Handle this! This is the connection breaking - kill the handler!
//   }.bind(this));

//   if(this.connectionsByConnId[clientInfo.connId]) {
//     // @todo is it necessary to close/end this if it exists?
//     delete this.connectionsByConnId[clientInfo.connId];
//   }

//   this.connectionsByConnId[clientInfo.connId] = {
//     request: request,
//     response: response,
...
//     } else {
//       console.log('CLOSING due to no clientInfo');
